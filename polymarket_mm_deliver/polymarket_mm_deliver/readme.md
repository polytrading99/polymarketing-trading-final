...
- `start_mm.sh`:
  ...
  - `nohup` runs `trade.py` → `ubuntu@vps-46dff1b8:~/poly-maker/polymarketing-trading-final$ docker exec -it polymarketing-trading-final-backend-1 python -m app.scripts.diagnose_bot_errors

======================================================================
  MM BOT DIAGNOSTIC TOOL
======================================================================
...
======================================================================
✗ PK: NOT SET
✗ BROWSER_ADDRESS: NOT SET
  SIGNATURE_TYPE: not set (using default)

======================================================================
  File Paths
======================================================================
✓ config.json: /app/polymarket_mm_deliver/polymarket_mm_deliver/config.json
✓ main_final.py: /app/polymarket_mm_deliver/polymarket_mm_deliver/main_final.py
✓ trade.py: /app/polymarket_mm_deliver/polymarket_mm_deliver/trade.py

======================================================================
  Configuration File
======================================================================
✓ Config file exists: /app/polymarket_mm_deliver/polymarket_mm_deliver/config.json

API Configuration:
  PRIVATE_KEY: SET
  PROXY_ADDRESS: 0x0D59cD8E7CC0C26797968aF2ceC74Cf913F4e788
  SIGNATURE_TYPE: 1
  CHAIN_ID: 137

Strategy Configuration:
  Strategy 1 ENABLED: True
  Strategy 2 ENABLED: False
...
✓ Config loaded successfully
  Keys: ['entry_exit', 'time_windows', 'late_mode', 'position_control', 'micro_tuning', 'elon_tweet_bot', 'api', 'strategies']

======================================================================
  Bot Startup Test
======================================================================
✓ Main script exists: /app/polymarket_mm_deliver/polymarket_mm_deliver/main_final.py
✓ Main script can be loaded

======================================================================
  Shared Memory
======================================================================
⚠ sysv_ipc not available (may use different shared memory mechanism)
  This is usually OK - the bot may use a different approach
